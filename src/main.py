...
class GitHubPRAnalyzer:
    ...
    def fetch_pr_diff(self, repo_owner: str, repo_name: str, pr_number: int) -> str:
        ...
        try:
            ...
            return diff_response.text, pr_data
            
        except requests.exceptions.RequestException as e:
            print(f"Error fetching PR diff: {e}")
            sys.exit(1)
    
    def analyze_with_openrouter(self, diff_content: str, pr_data: Dict[str, Any]) -> str:
        """
...
{diff_content}"""
    ...
    def save_to_markdown(self, analysis: str, pr_data: Dict[str, Any], 
...
def main():
    ...
    diff_content, pr_data = analyzer.fetch_pr_diff(repo_owner, repo_name, args.pr)
    
    print("Analyzing diff with OpenRouter...")
    analysis = analyzer.analyze_with_openrouter(diff_content, pr_data)
    
    print("Saving analysis to markdown...")
    analyzer.save_to_markdown(analysis, pr_data, repo_owner, repo_name, args.pr, args.output)
